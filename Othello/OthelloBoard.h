...
public:
	//====== Setters and Getters for Col and Rows =====START=====
	// Could Use struct. But, easier this way
	//Getter Functions for Col and Row
  int getC(){
    return col;
  }
  int getR(){
  ...
  void setR(int rows){
      row = rows;
		...
		//====== Setters and Getters for Col and Rows======END=====
	/**
